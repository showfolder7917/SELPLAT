...
/**
 * 统一声明公共增、查、改和假删除能力，只有采用公共 CRUD HTTP 路由的业务 Service 才继承本接口。
 * 非 CRUD 服务继续只继承 {@link BaseService}，避免元数据浏览、SQL 执行等控制器意外开放数据维护接口。
 */
public interface BaseCrudService extends BaseService {
