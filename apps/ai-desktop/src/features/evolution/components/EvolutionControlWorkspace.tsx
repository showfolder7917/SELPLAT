...
import { HanLiEvolutionApprovalPanel } from "./HanLiEvolutionApprovalPanel";
import { NangongEvolutionRail, type EvolutionWorkspaceFlowNode } from "./NangongEvolutionRail";
  ...
  return <aside className="evolution-control-workspace" aria-label="专项演化统一工作台" aria-busy={!workspacePreferenceReady} data-preference-ready={workspacePreferenceReady} data-preference-perspective={workspacePreferencePerspectiveRef.current || ""}>
    ...
    <div className="evolution-workspace-layout">
      ...
      <main ref={canvasRef} className="evolution-workspace-canvas" data-active-flow={flowNode}>
        ...
        {flowNode === "manual-group" && <EvolutionTopicGroupView topic={activeTopic} stateVersion={state.updatedAt} oneShotRun={state.oneShotRun} perspective={perspective} locale={locale} workspaces={workspaces} onNavigate={navigateToFlowNode} onState={onState} onError={onError} />}
