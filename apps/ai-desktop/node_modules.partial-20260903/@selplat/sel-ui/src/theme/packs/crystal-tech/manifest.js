...
(function selCrystalTechThemeRegister() {
    ...
    const selCrystalTechBackgroundDisplay = {
        dark: { overlay: 52, brightness: 86, blur: 0 },
        light: { overlay: 16, brightness: 96, blur: 0 }
    };
    ...
    function selCrystalTechAccents(selCrystalTechMode) {
        ...
        return selCrystalTechDefinitions.map(([selCrystalTechId, selCrystalTechLabel, selCrystalTechColor]) => ({
            id: selCrystalTechId,
    ...
    function selCrystalTechBackgrounds() {
        const selCrystalTechModeNames = { dark: "深空", light: "晨雾" };
        const selCrystalTechDefinitions = [
            ["stellar-blue", "星际蓝"],
            ["crystal-cyan", "水晶青"],
            ["nebula-purple", "星云紫"],
        ...
        return ["dark", "light"].flatMap((selCrystalTechMode) => [
            ...
            ...selCrystalTechDefinitions.map(([selCrystalTechId, selCrystalTechLabel]) => ({
        ...
        modes: [
            {
                ...
                preview: { surface: "#020816", card: "#07132E", main: "#F7FAFF", muted: "#AFC0DD", accent: "#8067FF" },
                base: {
                    color: "#4A8BFF",
                ...
                accents: selCrystalTechAccents("dark")
            },
            {
                id: "light",
                label: "浅色皮肤",
                ...
                icon: "ri-sun-line",
                preview: { surface: "#EAF3FB", card: "#DCE8F3", main: "#0B1633", muted: "#52617A", accent: "#4A8BFF" },
                base: {
                    color: "#3670B0",
                ...
                accents: selCrystalTechAccents("light")
            }
        ]
    });
})();
