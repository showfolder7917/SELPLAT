...
import type { AiMemoryDatabaseStatus, AppVariant } from "../../../contracts/desktop/desktop.js";
...
export function registerSystemIpc({ aiMemoryDatabaseStatus, projectRoot, variant, screenshots, workflowRepository, eventCenter }: SystemIpcDependencies): void {
