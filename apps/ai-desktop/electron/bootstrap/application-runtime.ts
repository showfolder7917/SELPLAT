 ...
 * - 源码真实出口是 services/capabilities/event-center/index.ts；
...
import { createAtomicJsonPersistence, type DatabasePort as SqliteDatabase } from "../services/platform/persistence/index.js";
...
import { TestDataResetService } from "../application/test-data-reset.service.js";
