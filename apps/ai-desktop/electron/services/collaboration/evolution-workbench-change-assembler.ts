import type { EvolutionWorkbenchChangeEvent, EvolutionWorkbenchView, NangongEvolutionState } from "../../../contracts/collaboration/nangong-evolution.js";
...
export function buildEvolutionWorkbenchChange(
  previous: NangongEvolutionState,
  current: NangongEvolutionState,
  reason: string,
  topicId: string | null,
