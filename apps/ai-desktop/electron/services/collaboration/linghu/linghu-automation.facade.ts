...
import type { CollaborationMember, CollaborationState, CollaborationTask, DesktopOperatingMode, SubmitCollaborationTaskRequest } from "../../../../contracts/collaboration/collaboration.js";
...
import { UnifiedTestInfrastructureError } from "./internal/linghu-unified-test.runner.js";
...
export interface LinghuAutomationFacadeOptions {
  ...
  submitRepairProposal?(request: CreateLinghuRepairProposalOutDto): NangongEvolutionState;
