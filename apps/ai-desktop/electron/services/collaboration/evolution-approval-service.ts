...
import type { EvolutionApprovalDecision, EvolutionApprovalSource, EvolutionFeedbackTarget, EvolutionProposal, NangongEvolutionState } from "../../../contracts/collaboration/nangong-evolution.js";
...
export class EvolutionApprovalService {
  constructor(private readonly store: NangongEvolutionStore, private readonly timeline: TimelineSink | null) {}

  recordApplication(proposalId: string): NangongEvolutionState {
  ...
  #publishApplication(state: NangongEvolutionState, proposal: EvolutionProposal): void {
  ...
  #publishSupplementWaiting(state: NangongEvolutionState, proposal: EvolutionProposal, advice: string, occurredAt: string): void {
    const topic = requireTopic(state, proposal.topicId);
  ...
  #publishSupplementCompleted(state: NangongEvolutionState, revision: EvolutionProposal): void {
...
function group(topic: NangongEvolutionState["topics"][number], proposal: EvolutionProposal, status: CollaborationTimelineBusinessEvent["group"]["status"], summary: string, updatedAt: string): CollaborationTimelineBusinessEvent["group"] {
