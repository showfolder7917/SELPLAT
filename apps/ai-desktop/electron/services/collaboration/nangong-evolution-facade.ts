...
export class NangongEvolutionFacade {
  ...
  createLinghuRepairProposal(request: CreateLinghuRepairProposalOutDto): NangongEvolutionState { const next = this.#store.createLinghuRepairProposal(request); return this.#approvals.recordApplication(next.proposals.at(-1)!.proposalId); }
