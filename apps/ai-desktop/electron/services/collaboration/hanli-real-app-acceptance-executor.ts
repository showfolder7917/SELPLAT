...
import type { HanLiAcceptanceOperation, HanLiAcceptancePlan, HanLiAcceptanceRun, HanLiAcceptanceStepResult } from "../../../contracts/collaboration/nangong-evolution.js";
...
export class HanLiRealAppAcceptanceExecutor {
