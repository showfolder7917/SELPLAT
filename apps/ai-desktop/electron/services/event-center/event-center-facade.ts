...
export class EventCenterFacade {
  ...
  #repository: WorkflowRepository | null = null;
  ...
  attachRepository(repository: WorkflowRepository | null): void {
  ...
  repository(): WorkflowRepository | null { return this.#repository; }
}
