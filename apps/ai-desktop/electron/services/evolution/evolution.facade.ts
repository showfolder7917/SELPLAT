...
import type { EvolutionTopicDossierOutDto, EvolutionWorkbenchPageOutDto, EvolutionWorkbenchPreferenceOutDto, EvolutionStateOutDto, QueryEvolutionWorkbenchInDto, SaveEvolutionWorkbenchPreferenceInDto } from "../../../contracts/services/evolution/index.js";
...
export class EvolutionFacade {
  ...
  queryWorkbench(request: QueryEvolutionWorkbenchInDto) { return this.#application.queryWorkbench(request); }
  ...
  saveWorkbenchPreference(request: SaveEvolutionWorkbenchPreferenceInDto) { return this.#application.saveWorkbenchPreference(request); }
