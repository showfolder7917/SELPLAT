...
export interface PersonaWorkflowApplicationPort {
  ...
  setComputerAcceptanceSession(runner: (goal: HanliComputerAcceptanceInDto, onStarted: () => void) => Promise<HanliAcceptanceRunOutDto>): void;
...
export class PersonaWorkflowFacade {
  ...
  setComputerAcceptanceSession(runner: (goal: HanliComputerAcceptanceInDto, onStarted: () => void) => Promise<HanliAcceptanceRunOutDto>) { this.#application.setComputerAcceptanceSession(runner); }
