...
export interface HanliApplicationServiceOptions {
  ...
  beginMutation?: (topicId: string, action: string, request: import("../../../../../contracts/collaboration/evolution/index.js").EvolutionMutationInDto, currentStateVersion: string) => "started" | "completed";
