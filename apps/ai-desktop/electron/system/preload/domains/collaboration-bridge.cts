...
export function collaborationBridge() {
  return {
    ...
    preparePersonaConversationRecovery: (personaId: string, request?: { conversationId?: string | null }) => invoke("desktop:prepare-persona-conversation-recovery", personaId, request),
