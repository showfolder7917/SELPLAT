...
export function collaborationBridge() {
  return {
    ...
    getHanliConversation: () => invoke("desktop:get-han-li-conversation"),
    sendHanliConversationMessage: (request: unknown) => invoke("desktop:send-han-li-conversation-message", request),
    newHanliConversation: () => invoke("desktop:new-han-li-conversation"),
