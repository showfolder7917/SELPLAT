...
contextBridge.exposeInMainWorld("desktop", {
  ...
  getApprovalGovernance: () => ipcRenderer.invoke("desktop:get-approval-governance"),
  ...
  generateNangongTopicDraft: (request: unknown) => ipcRenderer.invoke("desktop:generate-nangong-topic-draft", request),
  ...
  updateEvolutionTopic: (topicId: string, request: unknown) => ipcRenderer.invoke("desktop:update-evolution-topic", topicId, request),
  setNangongAutomation: (kind: string, enabled: boolean) => ipcRenderer.invoke("desktop:set-nangong-automation", kind, enabled),
  configureEvolutionAutomation: (request: unknown) => ipcRenderer.invoke("desktop:configure-evolution-automation", request),
  controlEvolutionAutomation: (action: string) => ipcRenderer.invoke("desktop:control-evolution-automation", action),
  ...
  decideEvolutionResult: (proposalId: string, request: unknown) => ipcRenderer.invoke("desktop:decide-evolution-result", proposalId, request),
