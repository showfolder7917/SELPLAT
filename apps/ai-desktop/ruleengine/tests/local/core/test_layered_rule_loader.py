...
ABILITY_PATH = (
    PROJECT_ROOT
    / "apps/ai-desktop/ruleengine/python/local/core/abilities"
...
class PythonLayeredRuleLoaderTest(unittest.TestCase):
    ...
    def test_validates_complete_production_index_trees(self) -> None:
        ...
        self.assertEqual(loader.IndexValidation(32, 104), user_validation)
    ...
    def test_python_is_the_only_layered_loading_implementation(self) -> None:
        ...
        registry = (
            ruleengine_root
            / "rules/local/core/registry/abilities.json"
