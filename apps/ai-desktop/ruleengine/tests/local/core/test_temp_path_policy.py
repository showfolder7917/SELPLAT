...
RULEENGINE_ROOT = (
    PROJECT_ROOT / "apps/ai-desktop/ruleengine/python/ruleengine"
)
...
PYTHON_ENTRY_PATHS = [
    ...
    PROJECT_ROOT / "apps/ai-desktop/ruleengine/tests/local"
    / ACTIVE_STABLE_USER_ID / "test_ai_rule_package_integrator.py",
]
# Python 测试统一入口必须在发现测试模块前设置同一个缓存根。
PYTHON_TEST_RUNNER_PATH = (
    PROJECT_ROOT / "apps/ai-desktop/ruleengine/tests/run_tests.py"
)
