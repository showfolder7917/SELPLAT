...
rule_engine_python_test_entry = apps/ai-desktop/ruleengine/tests/run_tests.py
rule_engine_python_test_command = python3 apps/ai-desktop/ruleengine/tests/run_tests.py all
...
execution_doc_manager_entry = python/ruleengine/执行器.py execution_doc_manager
...
test_doc_manager_entry = python/ruleengine/执行器.py test_doc_manager
...
task_lifecycle_manager_entry = python/ruleengine/执行器.py task_lifecycle_manager
