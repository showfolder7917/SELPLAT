...
<!-- MDA 主题选择器必须同时登记普通极简、晶透管理、水晶科技和糖果冒险四套公共主题。 -->
mda_theme_pack_set = plain-minimal_glass-admin_crystal-tech_candy-adventure
<!-- 新增普通极简只扩展用户选择范围，MDA 每次打开仍保持晶透管理深色作为默认主题。 -->
