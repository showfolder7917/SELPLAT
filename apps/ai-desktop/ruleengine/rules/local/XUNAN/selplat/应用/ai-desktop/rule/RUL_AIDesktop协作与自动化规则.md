...
hanli_acceptance_failure_repair_loop_contract = extract_current_run_failed_steps_with_actual_expected_and_mode_appropriate_evidence + page_failure_uses_reproduction_and_screenshots + code_conformance_failure_uses_source_diff_and_test_references + classify_product_defect_acceptance_capability_blocker_or_test_runtime_failure_before_dispatch + compare_each_failure_to_unchanged_original_acceptance_criterion + all_failures_within_original_scope_only_auto_repair + outside_or_unknown_scope_preserved_without_silent_expansion + linghu_creates_new_idempotent_repair_task_from_current_failure_evidence_not_old_plan + product_failure_requires_product_change_and_cannot_pass_by_acceptance_prompt_only + capability_blocker_cannot_change_product_to_fit_tool + same_reproduction_before_and_after + unchanged_original_symptom_marks_wrong_direction_and_prohibits_repeating_prior_fix + targeted_code_test + unified_test + loaded_runtime_version_update + restart_health_check + resume_same_proposal_same_acceptance_mode + hanli_reaccepts_and_repair_completion_never_substitutes_acceptance
