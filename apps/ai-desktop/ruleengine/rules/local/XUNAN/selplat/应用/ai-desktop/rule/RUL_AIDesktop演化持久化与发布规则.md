...
nangong_evolution_state_authority_contract = AiDesktopEvolutionState_singleton_is_only_runtime_authority + state_version_8_JSON_validated_inside_SQLite + no_nangong_evolution_JSON_read_write_migration_or_fallback + legacy_file_forensic_retention_only + first_database_state_recovers_visible_conversation_from_AiDesktopConversationMemory + database_unavailable_fails_closed_without_secondary_store
