...
<!-- 单一 Developer 产品线、官方 Codex harness、开发包工程根注入、发布包路径隔离、跨平台截图适配、自然协作表达、托管职责分离、令狐自动流程最后保障、运行时测试批次与外部工程文档边界、ChatGPT 账号登录和桌面执行审批由本应用规则统一约束。 -->
...
<!-- AI Desktop 的 contracts 领域分层、运行边界、模块解耦、业务注释、生产规则 bundle 和客户覆盖统一由本规则约束。 -->
AI_DESKTOP_ARCHITECTURE_BOUNDARY_RULES = local/XUNAN/selplat/应用/ai-desktop/rule/RUL_AIDesktop架构边界与客户规则交付规则.md

<!-- 整理 contracts、拆分 main/preload/renderer、解耦 IPC 与服务或按业务域分模块时加载。 -->
