...
SELPLAT_PROGRAM_SOURCE_LANGUAGE_AND_OWNERSHIP_GUARD_RULES = active-user/rules/平台/RUL_SELPLAT程序源码语言与归属门禁规则.md
...
SELPLAT_PROJECT_PATH_RULES = active-user/rules/平台/RUL_SELPLAT工程路径规则.md
