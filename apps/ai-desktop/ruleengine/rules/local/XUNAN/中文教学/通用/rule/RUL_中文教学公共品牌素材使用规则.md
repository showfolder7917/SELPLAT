...
<!-- chinese_teaching_brand_logo_must_not_cover.2 的当前独立事实为 body。 -->
chinese_teaching_brand_logo_must_not_cover.2 = body
<!-- chinese_teaching_brand_logo_must_not_cover.3 的当前独立事实为 pinyin。 -->
chinese_teaching_brand_logo_must_not_cover.3 = pinyin
<!-- chinese_teaching_brand_logo_must_not_cover.4 的当前独立事实为 illustration_subject。 -->
chinese_teaching_brand_logo_must_not_cover.4 = illustration_subject
<!-- chinese_teaching_brand_logo_must_not_cover.5 的当前独立事实为 navigation。 -->
chinese_teaching_brand_logo_must_not_cover.5 = navigation
<!-- chinese_teaching_brand_logo_must_not_cover.6 的当前独立事实为 teaching_safe_area。 -->
...
<!-- verification_contract.2 的当前独立事实为 all_consumers_use_single_path。 -->
verification_contract.2 = all_consumers_use_single_path
<!-- verification_contract.3 的当前独立事实为 legacy_brand_path_absent。 -->
