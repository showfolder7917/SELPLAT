...
<!-- sql_bean_base_type 的当前独立事实为 APZZSqlParamBase。 -->
...
<!-- sql_output_bean_pattern 的当前独立事实为 <SqlId>OutDataBean。 -->
...
<!-- issuer_orgni_nm_insert_required_fields.2 的当前独立事实为 CP_ISSUER_CD。 -->
issuer_orgni_nm_insert_required_fields.2 = CP_ISSUER_CD
<!-- issuer_orgni_nm_insert_required_fields.3 的当前独立事实为 ORGNI_NM。 -->
issuer_orgni_nm_insert_required_fields.3 = ORGNI_NM
<!-- issuer_orgni_nm_insert_required_fields.4 的当前独立事实为 CO_EDIT_NM。 -->
issuer_orgni_nm_insert_required_fields.4 = CO_EDIT_NM
<!-- issuer_orgni_nm_insert_required_fields.5 的当前独立事实为 CRE_SYS_DATE_AP。 -->
issuer_orgni_nm_insert_required_fields.5 = CRE_SYS_DATE_AP
<!-- issuer_orgni_nm_insert_required_fields.6 的当前独立事实为 CRE_OPE_DATE_AP。 -->
issuer_orgni_nm_insert_required_fields.6 = CRE_OPE_DATE_AP
<!-- issuer_orgni_nm_insert_required_fields.7 的当前独立事实为 CRE_BIZ_FUNC_AP。 -->
issuer_orgni_nm_insert_required_fields.7 = CRE_BIZ_FUNC_AP
<!-- issuer_orgni_nm_insert_required_fields.8 的当前独立事实为 UPD_SYS_DATE_AP。 -->
issuer_orgni_nm_insert_required_fields.8 = UPD_SYS_DATE_AP
<!-- issuer_orgni_nm_insert_required_fields.9 的当前独立事实为 UPD_OPE_DATE_AP。 -->
issuer_orgni_nm_insert_required_fields.9 = UPD_OPE_DATE_AP
<!-- issuer_orgni_nm_insert_required_fields.10 的当前独立事实为 UPD_BIZ_FUNC_AP。 -->
issuer_orgni_nm_insert_required_fields.10 = UPD_BIZ_FUNC_AP

## 业务固有部品定义规则

<!-- 名称编辑等业务固有部品必须以调用方提供的项目定义书为类名、包名、公开方法和注入依赖的事实来源；业务含义是生产 core 不保存项目人工资料，也禁止根据近似实现猜测专属部品。 -->
...
<!-- forbid_cpma_specific_behavior_in_apzz_common_component 的当前独立事实为 true。 -->
...
<!-- business_component_must_delegate_generic_string_operations_to_apzz_string_util 的当前独立事实为 true。 -->
...
<!-- required_mapper_change_verification.2 的当前独立事实为 checkstyle。 -->
required_mapper_change_verification.2 = checkstyle
<!-- required_mapper_change_verification.3 的当前独立事实为 xml_parse。 -->
required_mapper_change_verification.3 = xml_parse
<!-- required_mapper_change_verification.4 的当前独立事实为 mybatis_statement_registration。 -->
required_mapper_change_verification.4 = mybatis_statement_registration
<!-- required_mapper_change_verification.5 的当前独立事实为 bound_sql_parameter_binding。 -->
