...
rule_engine_python_test_entry = apps/ai-desktop/ruleengine/backend/src/test/python/run_tests.py
rule_engine_python_test_command = python3 apps/ai-desktop/ruleengine/backend/src/test/python/run_tests.py all
