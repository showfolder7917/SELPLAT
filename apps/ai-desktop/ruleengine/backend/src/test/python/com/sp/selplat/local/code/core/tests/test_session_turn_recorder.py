...
PYTHON_SOURCE_ROOT = PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/main/python"
...
class SessionTurnRecorderTests(unittest.TestCase):
    ...
    def test_protocol_and_root_index_register_standalone_three(self) -> None:
        ...
        root_index_text = (
            PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/main/resources/RULE_INDEX.md"
        ).read_text(encoding="utf-8")
        user_rule_text = (
            PROJECT_ROOT
            / "apps/ai-desktop/ruleengine/backend/src/main/resources/local/XUNAN/跨工程通用规则"
