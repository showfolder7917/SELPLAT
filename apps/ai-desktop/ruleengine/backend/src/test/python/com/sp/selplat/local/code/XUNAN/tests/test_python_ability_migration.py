...
BACKEND_ROOT = PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend"
XUNAN_CODE_ROOT = BACKEND_ROOT / "src/main/python/com/sp/selplat/local/code/XUNAN"
JAVA_LOCAL_ROOT = BACKEND_ROOT / "src/main/java/com/sp/selplat/local"
...
class PythonAbilityMigrationTests(unittest.TestCase):
    ...
    def test_xunan_has_no_java_node_or_executable_archive(self) -> None:
        ...
        for language, suffixes in (("java", {".java"}), ("node", {".js", ".mjs", ".cjs", ".ts"})):
            root = BACKEND_ROOT / f"src/main/{language}/com/sp/selplat/local/code/XUNAN"
            if root.exists():
    ...
    def test_active_rules_do_not_reference_removed_xunan_sources(self) -> None:
        ...
        rule_root = BACKEND_ROOT / "src/main/resources/local/XUNAN"
        violations = []
    ...
    def test_python_dependency_manifest_covers_migrated_formats(self) -> None:
        ...
        requirements = (BACKEND_ROOT / "requirements-python.txt").read_text(encoding="utf-8")
