...
RESOURCE_ROOT = PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/main/resources"
CORE_ROOT = RESOURCE_ROOT / "local/core"
ROOT_RULE_INDEX = RESOURCE_ROOT / "RULE_INDEX.md"
PYTHON_CORE_ROOT = (
    PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/main/python/com/sp/selplat/local/code/core"
)
RULEENGINE_ROOT = (
