...
RULEENGINE_ROOT = PYTHON_SOURCE_ROOT / "com/sp/selplat/ruleengine"
...
class TaskLifecycleManagerTests(unittest.TestCase):
    ...
    def test_path_config_contains_only_project_relative_values(self) -> None:
        ...
        config_path = PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/main/resources/ruleengine/config/路径配置.toml"
