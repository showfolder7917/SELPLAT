...
TEST_ROOT = PROJECT_ROOT / "apps/ai-desktop/ruleengine/backend/src/test/python/com/sp/selplat/local/code"
...
def main(arguments: list[str] | None = None) -> int:
    ...
    if scope != "all" and scope not in {*TEST_SCOPES, "performance"}:
        print(
            "Usage: python3 apps/ai-desktop/ruleengine/backend/src/test/python/run_tests.py "
