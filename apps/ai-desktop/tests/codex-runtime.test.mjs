...
const { CODEX_TARGET_VERSION, resolveCodexRuntime } = await import("../../../build/ai-desktop/electron/electron/services/platform/codex/internal/codex-runtime.resolver.js");
