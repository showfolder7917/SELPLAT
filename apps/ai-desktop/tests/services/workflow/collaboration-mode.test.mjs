...
test("令狐自动保障用户层规则登记全量检测、故障指纹、损坏恢复与固定报告", () => {
  ...
  assert.match(rule, /han_li_single_confirmation_and_message_projection_contract = exact_standalone_1_in_hanli_conversation_authorizes_current_one_shot_end_to_end[^\n]*internal_deliberation_matures_without_second_customer_confirmation[^\n]*customer_confirmation_message_only_uses_hanli_customer_visible_projection[^\n]*persona_internal_question_answer_and_offer_only_use_nangong_internal_projection/);
  assert.match(rule, /persona_outgoing_delivery_and_tail_visibility_contract = sending_and_completed_are_customer_visible_as_sent[^\n]*layout_generated_scroll_event_cannot_cancel_current_follow[^\n]*newest_message_bottom_never_below_composer_top/);
