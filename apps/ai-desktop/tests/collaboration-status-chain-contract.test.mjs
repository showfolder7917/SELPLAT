...
const integrationSource = readFileSync(new URL("../electron/services/collaboration/version-integration-pipeline.ts", import.meta.url), "utf8");
...
test("执行失败经令狐修复并固定回到原负责人", () => {
  assert.doesNotMatch(contractSource, /repairing-review|queued-reviewer/);
