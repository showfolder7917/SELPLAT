...
test("令狐页面只保留自动开关，后台恢复职责仍存在", () => {
  ...
  const router = [
    ...
    source("src/applications/developer/model/createDeveloperWorkspaceRouterViewModel.ts"),
    source("src/applications/developer/sections/DeveloperWorkspacePageSection.tsx"),
  ].join("\n");
