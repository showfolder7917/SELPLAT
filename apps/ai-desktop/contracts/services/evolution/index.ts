...
/** 提案版本冻结的验收条件、证据要求和验收轮次。 */
export type { EvolutionAcceptanceEvidenceTypeValue, EvolutionAcceptancePageSurfaceValue, EvolutionAcceptancePlanConditionOutDto, EvolutionAcceptancePlanOutDto, EvolutionAcceptanceRoundOutDto } from "./dto/evolution-acceptance-plan.out.dto.js";
/** 当前专题的统一只读阶段，供页面避免分别解释任务与验收事实。 */
export type { CurrentTopicAcceptanceOutDto, CurrentTopicFailureEvidenceOutDto, CurrentTopicHostStartupAcceptanceOutDto, CurrentTopicReadRecoveryOutDto, CurrentTopicStageDurationEvidenceOutDto, CurrentTopicStageOutDto, CurrentTopicStageStatusValue } from "./dto/current-topic-stage.out.dto.js";
...
export type { EvolutionAutomationRuntimeOutDto, EvolutionAutomationSettingsOutDto } from "./dto/evolution-automation.out.dto.js";
export type { EvolutionMutationInDto } from "./dto/evolution-mutation.in.dto.js";
export type { EvolutionOneShotConfirmationOutDto, EvolutionOneShotRunOutDto } from "./dto/evolution-one-shot-run.out.dto.js";
export type { EvolutionOneShotPhaseValue } from "./value/evolution-one-shot-run.value.js";
