...
export type DesktopCapabilityDefinition<Method extends ApiMethod> = {
 ...
 */
export type DesktopCapabilityRegistry = {
  [CapabilityId in keyof DesktopApi]: DesktopApi[CapabilityId] extends ApiMethod
    ? DesktopCapabilityDefinition<DesktopApi[CapabilityId]>
    : never;
};
...
export const DESKTOP_CAPABILITY_DOMAINS = {
  ...
  system: ["getEnvironment", "getAiMemoryDatabaseStatus", "getSettings", "updateSettings", "getWorkspaces", "addWorkspace", "updateWorkspacePermission", "setPrimaryWorkspace", "removeWorkspace", "listWorkspaceEntries", "openExternalUrl", "getTempDirectoryInfo", "openTempDirectory", "clearTempFiles", "getAuditLogInfo", "openAuditLogDirectory", "reportRendererException", "windowControl"],
  ...
  collaboration: ["getCollaborationState", "setDesktopOperatingMode", "selectCollaborationMember", "createCollaborationMember", "updateCollaborationMember", "deleteCollaborationMember", "submitCollaborationTask", "continueCollaborationTask", "cancelCollaborationTask", "onCollaborationState", "onCollaborationStream", "getLinghuAutomationState", "setLinghuAutomationEnabled", "createLinghuStartupPrompt", "updateLinghuStartupPrompt", "deleteLinghuStartupPrompt", "selectLinghuStartupPrompt", "onLinghuAutomationState", "getNangongEvolutionState", "openEvolutionWorkspace", "onEvolutionWorkspacePerspective", "getEvolutionTopicDossier", "advanceHanLiDeliberation", "createEvolutionTopic", "setNangongAutomation", "configureEvolutionAutomation", "controlEvolutionAutomation", "sendNangongConversationMessage", "newNangongConversation", "generateNangongTopicDraft", "convertNangongConversationToTopic", "createEvolutionProposal", "updateEvolutionTopic", "createLinghuRepairProposal", "decideEvolutionProposal", "decideEvolutionResult", "reviseEvolutionProposal", "autoApproveEvolutionProposal", "dispatchEvolutionProposal", "onNangongEvolutionState"],
...
} as const satisfies Record<string, readonly (keyof DesktopCapabilityRegistry)[]>;
