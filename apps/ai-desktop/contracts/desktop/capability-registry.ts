...
export const DESKTOP_CAPABILITY_DOMAINS = {
  ...
  system: ["getEnvironment", "getAiMemoryDatabaseStatus", "clearTestData", "getSettings", "updateSettings", "getWorkspaces", "addWorkspace", "updateWorkspacePermission", "setPrimaryWorkspace", "removeWorkspace", "listWorkspaceEntries", "openExternalUrl", "getTempDirectoryInfo", "openTempDirectory", "clearTempFiles", "getAuditLogInfo", "openAuditLogDirectory", "reportRendererException", "windowControl"],
