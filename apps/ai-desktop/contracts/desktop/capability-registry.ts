...
export const DESKTOP_CAPABILITY_DOMAINS = {
  ...
  collaboration: ["getCollaborationState", "getCollaborationTimeline", "onCollaborationTimelineChanged", "setDesktopOperatingMode", "selectCollaborationMember", "createCollaborationMember", "updateCollaborationMember", "deleteCollaborationMember", "submitCollaborationTask", "continueCollaborationTask", "cancelCollaborationTask", "onCollaborationState", "onCollaborationStream", "getLinghuAutomationState", "setLinghuAutomationEnabled", "createLinghuStartupPrompt", "updateLinghuStartupPrompt", "deleteLinghuStartupPrompt", "selectLinghuStartupPrompt", "onLinghuAutomationState", "getEvolutionState", "openEvolutionWorkspace", "onEvolutionWorkspaceLocation", "getEvolutionTopicDossier", "queryEvolutionWorkbench", "getEvolutionWorkbenchPreference", "saveEvolutionWorkbenchPreference", "onEvolutionWorkbenchChanged", "advanceHanLiDeliberation", "createEvolutionTopic", "setEvolutionAutomationEnabled", "configureEvolutionAutomation", "controlEvolutionAutomation", "resumeEvolutionOneShot", "sendNangongConversationMessage", "newNangongConversation", "generateNangongTopicDraft", "convertNangongConversationToTopic", "createEvolutionProposal", "updateEvolutionTopic", "createLinghuRepairProposal", "decideEvolutionProposal", "decideEvolutionResult", "generateHanLiAcceptancePlan", "executeHanLiAcceptancePlan", "reviseEvolutionProposal", "autoApproveEvolutionProposal", "dispatchEvolutionProposal", "onEvolutionState"],
