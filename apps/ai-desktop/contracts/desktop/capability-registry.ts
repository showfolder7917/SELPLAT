...
export const DESKTOP_CAPABILITY_DOMAINS = {
  ...
  collaboration: ["getCollaborationState", "getCollaborationTimeline", "setDesktopOperatingMode", "selectCollaborationMember", "createCollaborationMember", "updateCollaborationMember", "deleteCollaborationMember", "submitCollaborationTask", "continueCollaborationTask", "cancelCollaborationTask", "onCollaborationState", "onCollaborationStream", "getLinghuAutomationState", "setLinghuAutomationEnabled", "createLinghuStartupPrompt", "updateLinghuStartupPrompt", "deleteLinghuStartupPrompt", "selectLinghuStartupPrompt", "onLinghuAutomationState", "getNangongEvolutionState", "openEvolutionWorkspace", "onEvolutionWorkspaceLocation", "getEvolutionTopicDossier", "queryEvolutionWorkbench", "getEvolutionWorkbenchPreference", "saveEvolutionWorkbenchPreference", "onEvolutionWorkbenchChanged", "advanceHanLiDeliberation", "createEvolutionTopic", "setNangongAutomation", "configureEvolutionAutomation", "controlEvolutionAutomation", "resumeNangongOneShotEvolution", "sendNangongConversationMessage", "newNangongConversation", "generateNangongTopicDraft", "convertNangongConversationToTopic", "createEvolutionProposal", "updateEvolutionTopic", "createLinghuRepairProposal", "decideEvolutionProposal", "decideEvolutionResult", "generateHanLiAcceptancePlan", "executeHanLiAcceptancePlan", "reviseEvolutionProposal", "autoApproveEvolutionProposal", "dispatchEvolutionProposal", "onNangongEvolutionState"],
