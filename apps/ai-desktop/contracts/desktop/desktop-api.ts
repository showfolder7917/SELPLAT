...
import type { CollaborationStateOutDto, CollaborationStateEventOutDto, CollaborationStreamEventOutDto, CollaborationTimelineChangedEventOutDto, CollaborationTimelineSnapshotOutDto, CreateCollaborationMemberInDto, DesktopOperatingMode, SubmitCollaborationTaskInDto, UpdateCollaborationMemberInDto } from "../collaboration/workflow/index.js";
...
import type { EvolutionMutationInDto, EvolutionStateEventOutDto, EvolutionStateOutDto, EvolutionTopicDossier, EvolutionWorkbenchChangeEvent, EvolutionWorkbenchPage, EvolutionWorkbenchPreference, EvolutionWorkspaceLocation, QueryEvolutionWorkbenchRequest, SaveEvolutionWorkbenchPreferenceRequest } from "../collaboration/evolution/index.js";
import type { DecideHanliProposalInDto, DecideHanliResultInDto, HanliAcceptancePlanOutDto, HanliAcceptanceRunOutDto } from "../collaboration/hanli/index.js";
import type { ConvertNangongConversationToTopicInDto, CreateNangongProposalInDto, CreateNangongTopicInDto, GenerateNangongTopicDraftInDto, NangongTopicDraftOutDto, ReviseNangongProposalInDto, SendNangongConversationMessageInDto, UpdateNangongTopicInDto } from "../collaboration/nangong/index.js";
import type { ConfigurePersonaWorkflowInDto, PersonaWorkflowActionInDto } from "../collaboration/workflow/index.js";
...
export interface DesktopApi {
  ...
  /** 在单会话与协同模式之间切换并持久化状态。 */
  setDesktopOperatingMode(mode: DesktopOperatingMode): Promise<CollaborationStateOutDto>;
