...
export interface DesktopApi {
  ...
  /** 读取已登记工作区中的一层目录，不接受绝对路径。 */
  listWorkspaceDirectory(workspaceId: string, relativePath?: string): Promise<WorkspaceDirectoryOutDto>;
  /** 打开已登记工作区内的文件；文本返回预览，PPT/PPTX 由主进程交给系统默认应用。 */
  openWorkspaceFile(workspaceId: string, relativePath: string): Promise<WorkspaceFileOpenOutDto | WorkspaceSystemFileOpenFailedOutDto>;
  ...
  preparePersonaConversationRecovery(personaId: string, request?: Pick<ReadPersonaConversationWindowInDto, "conversationId">): Promise<PersonaConversationOutDto>;
