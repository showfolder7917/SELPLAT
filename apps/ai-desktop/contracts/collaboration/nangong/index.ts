/** 南宫婉契约唯一公开入口；显式符号使每个输入和输出都能定位到物理文件。 */
export type { NangongConversationMessageOutDto, NangongConversationOutDto } from "./dto/conversation.out.dto.js";
...
export type { SendNangongConversationMessageInDto } from "./dto/send-conversation-message.in.dto.js";
