...
/** 定义题目编辑窗口可直接调用的 Codex 解释、Codex 图片和日语语音能力。 */
public interface JapaneseQuestionContentService {

    /**
     * 根据公共参数容器中的题干、选项和正确答案生成中文解释。
     ...
     * @return Codex 生成的中文题目解释公共结果
     */
    CommonResult generateExplanation(CommonParam request);

    /**
     * 根据公共参数容器中的题目上下文生成并存储 WebP 图片。
    ...
    /**
     * 根据公共参数容器中的日语文本生成并存储 NanamiNeural 语音。
