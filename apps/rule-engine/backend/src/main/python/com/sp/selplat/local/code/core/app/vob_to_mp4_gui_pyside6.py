...
# 从迁移后的深层包向上识别工作区根目录，确保输出继续归属当前工程。
WORKSPACE_ROOT = next(
    candidate
...
CONVERSION_MODES = {
    "vob_to_mp4": {
        ...
        "input_suffixes": [".vob"],
        "output_suffix": ".mp4",
        "skill_file": CODE_ROOT / "skill" / "ffmpeg_vob_to_mp4.py",
    ...
    "vob_to_mp3": {
        ...
        "input_suffixes": [".vob"],
        "output_suffix": ".mp3",
        "skill_file": CODE_ROOT / "skill" / "ffmpeg_vob_to_mp3.py",
    ...
    "mp4_to_wav": {
        ...
        "input_suffixes": [".mp4"],
        "output_suffix": ".wav",
        "skill_file": CODE_ROOT / "skill" / "ffmpeg_mp4_to_wav.py",
