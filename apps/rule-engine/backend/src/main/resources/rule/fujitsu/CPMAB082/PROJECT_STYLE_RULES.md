...
<!-- 离线依赖缺失时进入同项目独立规则模块；业务含义是本文件只声明验证目标，具体回退顺序保持单一权威来源 -->
offline_dependency_handling_rule = apps/rule-engine/backend/src/main/resources/rule/fujitsu/CPMAB082/OFFLINE_DEPENDENCY_RULES.md
