...
normal_business_branches_must_use_real_database_fixture_data = update,insert,delete,zero_count,nonzero_count,loop,batch,normal_return
...
real_data_coverage_strategy_forbids_mock_and_reflection = mapper_return_count,query_result,technical_exception
...
jacoco_four_metrics = instruction,branch,line,method
...
real_database_coverage_completion_evidence = executed_case_count,database_expected_diff,real_constraint_root_cause,jacoco_instruction_branch_line_method_counts
