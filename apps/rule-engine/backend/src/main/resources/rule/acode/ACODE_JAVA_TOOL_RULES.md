...
java_rule_tool_source_root = apps/rule-engine/backend/src/main/java/com/sp/selplat/ruleengine/fujitsu

<!-- Fujitsu Java 包统一使用 com.sp.selplat.ruleengine.fujitsu，并按 db、sql 等能力继续分包；业务含义是组织边界清晰且不保留旧客户工程包名 -->
fujitsu_java_rule_tool_package_root = com.sp.selplat.ruleengine.fujitsu
