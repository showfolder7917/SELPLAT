...
selplat_rule_java_root = apps/rule-engine/backend/src/main/java/com/sp/selplat/code
...
selplat_project_common_rule_root = apps/rule-engine/backend/src/main/resources/selplat/通用规则
