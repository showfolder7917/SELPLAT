...
<!-- Java 生成和修正程序位于 Fujitsu SQL app，同一入口同时供人工命令与 AI 调用。 -->
java_ability_refs = com.sp.selplat.local.code.common.fujitsu.app.sql.SQL仕様書生成ツール,com.sp.selplat.local.code.common.fujitsu.app.sql.GenericSqlSpecDocCorrector
<!-- 当前规则不需要 Python 程序。 -->
...
sql_spec_common_format_demo = apps/rule-engine/backend/src/main/resources/local/common/fujitsu/通用/template/RUL_FujitsuSQL规格书Excel生成规则/SQL仕様書生成ツール/reference/SQL仕様書_アラート情報一括登録.xlsx
