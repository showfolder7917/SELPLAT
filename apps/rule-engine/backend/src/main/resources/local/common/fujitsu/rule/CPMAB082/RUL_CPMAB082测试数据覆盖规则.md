...
source_tables = TB_FCPCORP,TB_FCPISSUER
target_table = TB_FCPISSUERORGNINM
target_contract = CO_CD,CP_ISSUER_CD,ORGNI_NM,CO_EDIT_NM,six_AP_audit_fields
...
completion_evidence = successful_test_count,database_diff_result,jacoco_instruction_branch_line_method_counts,offline_fallback_reason,residual_risks
