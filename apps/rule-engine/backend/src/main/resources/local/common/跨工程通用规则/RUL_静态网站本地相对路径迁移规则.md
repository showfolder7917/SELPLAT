...
static_site_existing_root_reference_must_be_relative = href,src,action,data-src,css_url
...
static_site_local_migration_evidence = original_domain_zero,existing_root_reference_zero,entry_local_target_all_exist,missing_asset_count
