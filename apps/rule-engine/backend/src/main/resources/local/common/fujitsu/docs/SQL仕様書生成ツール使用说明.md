...
- 通用生成器：`src/main/java/com/sp/selplat/local/code/common/fujitsu/sql/SQL仕様書生成ツール.java`
- 新规示例 JSON：`src/main/resources/fujitsu/template/sql/SQL仕様書生成ツール/SQL仕様書生成ツール新規.json`
- 通用格式 Demo：`src/main/resources/fujitsu/template/sql/SQL仕様書生成ツール/reference/SQL仕様書_アラート情報一括登録.xlsx`
