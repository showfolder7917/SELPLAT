...
selplat_resizable_window_must_define = minimum_width,minimum_height,viewport_safe_gap
...
selplat_resizable_window_maximize_must_preserve = pre_maximize_left,pre_maximize_top,pre_maximize_width,pre_maximize_height
