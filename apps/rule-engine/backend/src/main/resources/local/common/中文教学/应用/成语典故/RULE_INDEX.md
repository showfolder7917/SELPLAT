...
chinese_teaching_idiom_story_rule_root = local/common/中文教学/应用/成语典故/rule/

IDIOM_FABLE_PICTURE_BOOK_PPT_RULES = local/common/中文教学/应用/成语典故/rule/RUL_成语典故绘本PPT制作规则.md
load_rule_for_idiom_fable_picture_book_ppt_generation = IDIOM_FABLE_PICTURE_BOOK_PPT_RULES

PRIMARY_SCHOOL_IDIOM_STORY_PICTURE_BOOK_RULES = local/common/中文教学/应用/成语典故/rule/RUL_小学成语典故国风连续绘本图片生成规则.md
