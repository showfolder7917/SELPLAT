...
<!-- 中文教学一级目录只汇总“通用”和“应用”分类，并保留语言原生代码入口。 -->
...
<!-- 中文教学共享规则与公共真实材料由通用索引维护。 -->
CHINESE_TEACHING_GENERAL_RULE_INDEX = local/common/中文教学/通用/RULE_INDEX.md

<!-- 中文教学二级业务项目统一从应用汇总索引进入。 -->
CHINESE_TEACHING_APPLICATION_RULE_INDEX = local/common/中文教学/应用/RULE_INDEX.md
