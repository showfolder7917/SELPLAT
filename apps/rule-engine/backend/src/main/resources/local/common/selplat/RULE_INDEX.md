...
<!-- 本索引维护 SELPLAT 全平台通用规则，并汇总各应用项目索引。 -->
selplat_common_rule_root = local/common/selplat/通用规则/
selplat_application_rule_root = local/common/selplat/应用规则/
selplat_application_rule_path_pattern = local/common/selplat/应用规则/<app>/

<!-- SELPLAT 应用项目索引。 -->
SELPLAT_UNIAUTH_RULE_INDEX = local/common/selplat/应用规则/uniauth/RULE_INDEX.md
SELPLAT_RULE_ENGINE_RULE_INDEX = local/common/selplat/应用规则/rule-engine/RULE_INDEX.md

<!-- SELPLAT 水晶窗体、菜单、浮层和面板材质。 -->
SELPLAT_CRYSTAL_UI_MATERIAL_RULES = local/common/selplat/通用规则/RUL_SELPLAT水晶界面材质规则.md
...
SELPLAT_PROJECT_PATH_RULES = local/common/selplat/通用规则/RUL_SELPLAT工程路径规则.md
...
SELPLAT_PROJECT_BUILD_RULES = local/common/selplat/通用规则/RUL_SELPLAT工程构建规则.md
...
SELPLAT_JAVA_BUSINESS_COMMENT_AND_RETURN_EXAMPLE_RULES = local/common/selplat/通用规则/RUL_Java业务注释与返回示例规则.md
...
SELPLAT_BASE_SERVICE_DAO_ACCESS_RULES = local/common/selplat/通用规则/RUL_基础Service统一DAO访问规则.md
...
<!-- SELPLAT 真实数据库集成测试。 -->
SELPLAT_REAL_DATABASE_INTEGRATION_TEST_RULES = local/common/selplat/通用规则/RUL_SELPLAT真实数据集成测试规则.md
...
SELPLAT_CONTROLLER_SERVICE_RESULT_SERIALIZATION_RULES = local/common/selplat/通用规则/RUL_Controller仅序列化Service返回结构规则.md
...
<!-- SELPLAT 规则适配审查与冲突阻断。 -->
SELPLAT_RULE_COMPATIBILITY_BLOCKING_RULES = local/common/selplat/通用规则/RUL_SELPLAT规则适配审查与阻断规则.md
