...
offline_dependency_shared_handling_rule = local/common/fujitsu/通用/rule/RUL_FujitsuGradle离线依赖闭包恢复规则.md

<!-- CPMAB082 的只读参考工程和持久层替代验证差异由项目配置规则补充；业务含义是项目模块只维护自身特例 -->
offline_dependency_project_configuration_rule = local/common/fujitsu/应用/CPMAB082/rule/RUL_CPMAB082离线依赖配置规则.md
