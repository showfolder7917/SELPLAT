...
- 通用生成器：`src/main/java/com/sp/selplat/local/code/common/fujitsu/app/sql/SQL仕様書生成ツール.java`
- 新规示例 JSON：`src/main/resources/local/common/fujitsu/通用/template/RUL_FujitsuSQL规格书Excel生成规则/SQL仕様書生成ツール/SQL仕様書生成ツール新規.json`
- 通用格式 Demo：`src/main/resources/local/common/fujitsu/通用/template/RUL_FujitsuSQL规格书Excel生成规则/SQL仕様書生成ツール/reference/SQL仕様書_アラート情報一括登録.xlsx`
