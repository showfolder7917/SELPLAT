...
<!-- query_result_cardinality_change_requires_file_test_section_sync.2 的当前独立事实为 distinct。 -->
query_result_cardinality_change_requires_file_test_section_sync.2 = distinct
<!-- query_result_cardinality_change_requires_file_test_section_sync.3 的当前独立事实为 group_by。 -->
