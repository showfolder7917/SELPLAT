...
single_suite_divergence_diagnosis = shared_static_state,log_residue,database_residue,mutable_fixture_completeness,execution_order
...
forbid_one_execution_mode_as_substitute_for_the_other = full_suite,single_case
