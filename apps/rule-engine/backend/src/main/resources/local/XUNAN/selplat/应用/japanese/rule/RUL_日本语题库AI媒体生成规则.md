...
<!-- python_ability_refs.2 的当前独立事实为 apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/XUNAN/abilities/japanese_n2_ai_question_reviewer.py。 -->
python_ability_refs.2 = apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/XUNAN/abilities/japanese_n2_ai_question_reviewer.py
