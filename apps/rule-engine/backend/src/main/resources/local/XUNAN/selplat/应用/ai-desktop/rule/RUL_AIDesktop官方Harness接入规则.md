...
<!-- 5.54.0 将人物页长报告收回所属流程环节，并用真实状态生成唯一当前进度。 -->
rule_version = 5.54.0
<!-- 规则所有者始终从工程根稳定用户声明解析。 -->
...
<!-- 5.54.0 防止分析报告、证据和评分继续冒充人物当前任务进度。 -->
upgrade_record_5_54 = 2026-08-23:人物当前任务固定状态卡_真实负责人事项步骤更新时间和下一去向_意图分析审批执行问题修复统一测试五折叠条_当前环节自动展开定位_长内容按所属环节收纳_状态变化禁止停留旧分析页
