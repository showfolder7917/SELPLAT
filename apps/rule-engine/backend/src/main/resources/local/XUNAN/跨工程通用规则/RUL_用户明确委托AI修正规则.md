...
explicit_ai_managed_merge_or_delete_requires = retained_winner,reference_cleanup,index_cleanup,relevant_regression
<!-- AI 不得把一次明确修改扩展为无关清理、新功能或其他目录重构。 -->
explicit_ai_managed_change_forbidden = scope_expansion,unrelated_cleanup,unrequested_feature,unrelated_refactor
