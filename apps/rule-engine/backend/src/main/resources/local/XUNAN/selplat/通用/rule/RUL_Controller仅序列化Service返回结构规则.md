...
<!-- selplat_common_result_error_fields.2 的当前独立事实为 errorCode:String。 -->
selplat_common_result_error_fields.2 = errorCode:String
<!-- selplat_common_result_error_fields.3 的当前独立事实为 requestId:String。 -->
selplat_common_result_error_fields.3 = requestId:String
<!-- selplat_common_result_error_fields.4 的当前独立事实为 stackTrace:String。 -->
...
<!-- selplat_common_result_error_type_contract.2 的当前独立事实为 SYSTEM:generic_system_message。 -->
...
<!-- selplat_common_result_stack_trace_profile_policy.2 的当前独立事实为 prod:omit。 -->
...
<!-- selplat_common_web_request_trace_path 的当前独立事实为 /api/**。 -->
...
<!-- selplat_application_duplicate_common_web_registration 的当前独立事实为 forbidden。 -->
...
<!-- selplat_fixed_response_types.2 的当前独立事实为 CommonPageResult。 -->
...
<!-- selplat_response_field_extension_requires_explicit_user_confirmation 的当前独立事实为 true。 -->
...
<!-- selplat_batch_common_result_affected_rows 的当前独立事实为 CommonResult.affectedRows:Integer。 -->
selplat_batch_common_result_affected_rows = CommonResult.affectedRows:Integer
<!-- selplat_batch_common_result_must_not_wrap_data_map 的当前独立事实为 true。 -->
