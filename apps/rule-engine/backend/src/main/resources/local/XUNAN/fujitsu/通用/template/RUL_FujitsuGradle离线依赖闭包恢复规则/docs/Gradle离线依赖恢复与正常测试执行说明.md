...
```powershell
python3 "${SELPLAT_ROOT}/apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/${ACTIVE_STABLE_USER_ID}/abilities/fujitsu_gradle_offline_test_restorer.py" '<context_json>'
```
