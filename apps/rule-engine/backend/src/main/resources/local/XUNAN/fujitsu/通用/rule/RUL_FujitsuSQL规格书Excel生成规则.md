...
python_ability_refs = apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/XUNAN/abilities/fujitsu_excel_tools.py
<!-- 当前规则不再使用 Java 能力。 -->
...
sql_spec_common_format_demo = apps/rule-engine/backend/src/main/resources/local/XUNAN/fujitsu/通用/template/RUL_FujitsuSQL规格书Excel生成规则/SQL仕様書生成ツール/reference/SQL仕様書_アラート情報一括登録.xlsx
