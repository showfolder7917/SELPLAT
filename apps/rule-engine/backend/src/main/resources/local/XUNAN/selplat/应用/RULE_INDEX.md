...
<!-- ai-desktop 保存官方 Codex harness、开发包工程根注入与发布包路径隔离、单一生产 CSS 与正式桌面尺寸验证、macOS 与 Windows 共用截图流程及平台取帧适配、运行时路径不外露、自然回复与托管职责分离、ChatGPT 登录、最低需求审核、协同真实发起人与阶段操作者留痕、集成依赖自愈、新建任务入口和执行审批边界。 -->
