...
python_ability_refs = apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/<active-stable-user-id>/abilities/fujitsu_gradle_offline_test_restorer.py
<!-- 本规则不提供 Node 能力。 -->
