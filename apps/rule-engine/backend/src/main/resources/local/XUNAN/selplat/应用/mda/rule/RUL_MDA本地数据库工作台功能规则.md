...
<!-- 3.2.0 删除 MDA 专属架构口径；本规则只保存工作台业务行为，源码结构完全服从 SELPLAT 通用门禁。 -->
rule_version = 3.2.0
...
mda_table_context_actions = edit_structure_delete_real_target_object_copy_display_label_with_table_type_physical_table_export_last
