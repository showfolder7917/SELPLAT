...
<!-- selplat_rule_engine_forbidden_source_root.2 的当前独立事实为 apps/rule-engine/backend/src/main/node。 -->
selplat_rule_engine_forbidden_source_root.2 = apps/rule-engine/backend/src/main/node
