...
fujitsu_shared_rule_root = apps/rule-engine/backend/src/main/resources/local/XUNAN/fujitsu/通用/rule/
<!-- fujitsu_project_specific_rule_root 的当前独立事实为 apps/rule-engine/backend/src/main/resources/local/XUNAN/fujitsu/应用/<project>/rule/。 -->
fujitsu_project_specific_rule_root = apps/rule-engine/backend/src/main/resources/local/XUNAN/fujitsu/应用/<project>/rule/
