...
- `src/main/resources/local/core/registry/`：机器可读索引层，说明“这里有哪些能力、技能、应用”。
...
3. 再读 `src/main/resources/local/core/registry/abilities.json`，理解系统对外暴露了哪些正式能力。
4. 再读同目录的 `skills.json` 和 `apps.json`，理解 ability 依赖了哪些内部部件。
...
- 执行时优先通过 `./apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/core/executor.py`。
- `executor.py` 会读取 `src/main/resources/local/core/registry/` 下的三份唯一注册表。
...
- `src/main/resources/local/core/registry/skills.json`
- `src/main/resources/local/core/registry/apps.json`
...
- `./apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/core/router.py`
...
- `./apps/rule-engine/backend/src/main/resources/local/core/registry/skills.json`
...
- `./apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/core/skill/`
- `./apps/rule-engine/backend/src/main/python/com/sp/selplat/local/code/core/app/`
...
- 想知道“任务有没有正式 ability”：看 `src/main/resources/local/core/registry/abilities.json`
...
- `./apps/rule-engine/backend/src/main/resources/local/core/docs/code/TEMPLATE.md`
