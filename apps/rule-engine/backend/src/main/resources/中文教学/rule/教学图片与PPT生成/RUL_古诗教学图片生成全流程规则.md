...
chinese_teaching_brand_icon_asset = 中文教学/assets/品牌/新思度华文学堂.png
...
poetry_workspace_responsibility_directories = <当前临时目录>/PPT排版数据（可由DOCX重新生成） + 公共/工具 + 中文教学/rule/教学图片与PPT生成
