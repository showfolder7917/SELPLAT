...
java_rule_tool_source_root = apps/rule-engine/backend/src/main/java/com/sp/selplat/code/fujitsu

<!-- Fujitsu Java 包统一使用 com.sp.selplat.code.fujitsu，并按 db、sql 等能力继续分包；业务含义是 AI 执行代码与业务大模块边界清晰 -->
fujitsu_java_rule_tool_package_root = com.sp.selplat.code.fujitsu
