...
class PlatformRuntimeApplicationTest {
     ...
     * 真实返回示例：树接口返回 REFERENCE_DATA_TREE_NOT_FOUND，空题库列表返回 records 数组。
