package com.sp.selplat.aifactory.aiartifact.service.impl;

import com.sp.selplat.aifactory.aiartifact.service.AiArtifactService;
...
public class AiArtifactServiceImpl implements AiArtifactService {
     ...
     * @param dao 控制面 DAO
     */
    public AiArtifactServiceImpl(AiTaskService taskService) { this.taskService = taskService; }
    ...
    public CommonResult register(CommonParam command) {
        ...
        return AiFactoryResults.success(taskService.registerArtifact(command), "产物摘要已登记。");
    }
