...
public class ReferenceDataPersistenceConfiguration {
    ...
    public ReferenceDataDatabase referenceDataDatabase(
        ...
        try {
            ...
            return new ReferenceDataDatabase(dataSource, jdbcTemplate, transactionTemplate);
    ...
    public BaseDataSourceContext referenceDataBaseDataSourceContext(ReferenceDataDatabase database) {
