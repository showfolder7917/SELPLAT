package com.sp.selplat.referencedata.backend.persistence;
...
public class ReferenceDataDatabase {
     ...
     */
    public ReferenceDataDatabase(JdbcTemplate jdbcTemplate, TransactionTemplate transactionTemplate) {
