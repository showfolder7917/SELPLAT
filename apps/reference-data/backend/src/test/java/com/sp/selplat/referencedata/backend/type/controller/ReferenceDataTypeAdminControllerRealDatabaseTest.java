 ...
 */
@SpringBootTest(
        classes = ReferenceDataTypeAdminControllerRealDatabaseTest.TestApplication.class,
        properties = {
...
class ReferenceDataTypeAdminControllerRealDatabaseTest {
    ...
    void shouldManageReferenceDataTypesWithRealDatabase() throws Exception {
        ...
        mockMvc.perform(post("/api/reference-data/admin/types/2")
                        .param("projectCode", "cms")
                        .param("resourceCode", "article-category")
                        .param("nameZh", "内容分类")
                        .param("nameJa", "記事カテゴリ")
        ...
        mockMvc.perform(post("/api/reference-data/admin/types/2/delete"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.status").value(0));
        mockMvc.perform(get("/api/reference-data/admin/types").param("keyword", "article-category"))
                .andExpect(status().isOk())
