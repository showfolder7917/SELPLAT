-- ReferenceDataCoverageRealDatabaseTest.shouldExecuteTypeBatchCrudAndQueryBranches Case
...
) VALUES (100001, 1, 1, 100001, NULL, 'root', 'ROOT', '根节点', 1, 1);
INSERT INTO ReferenceDataOption (
    id, tenantId, lastOperateUserId, typeId, optionValue, labelZh, status, sortnum
) VALUES (100001, 1, 1, 100001, 'TREE', '树形资源', 1, 1);
