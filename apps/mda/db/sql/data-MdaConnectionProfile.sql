...
WHERE NOT EXISTS (
    ...
    WHERE databaseName = 'file:./apps/reference-data/db/reference-data'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM MdaConnectionProfile
    WHERE databaseName = 'file:./apps/japanese/db/japanese'
);
...
INSERT INTO MdaConnectionProfile (
    ...
    'file:./apps/ai-factiory/db/ai-factiory', 'PUBLIC',
    'sa', '123456', NULL,
