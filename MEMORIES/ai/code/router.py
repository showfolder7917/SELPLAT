...
def route_task(task_name: str) -> dict:
    ...
    # 计算能力注册表文件路径。
    abilities_registry_path = library_root / "registry" / "abilities.json"
    # 计算技能注册表文件路径。
    skills_registry_path = library_root / "registry" / "skills.json"
    # 计算应用注册表文件路径。
    apps_registry_path = library_root / "registry" / "apps.json"
    # 读取能力注册表。
